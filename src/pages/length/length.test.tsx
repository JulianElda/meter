...
describe("Metric units", () => {
  test("1 km: 1000 m", async () => {
    ...
    selectOption(user, FROM_LABEL, LengthUnits.km);
    selectOption(user, TO_LABEL, LengthUnits.m);
  ...
  test("1 km: 100000 cm", async () => {
    ...
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.km);
    selectOption(user, TO_LABEL, LengthUnits.cm);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 m: 0.001 km", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.m);
    selectOption(user, TO_LABEL, LengthUnits.km);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 cm: 0.01 m", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.cm);
    selectOption(user, TO_LABEL, LengthUnits.m);
    await typeInput(user, INPUT_LABEL, "1");
...
describe("Imperial units", () => {
  test("1 feet: 12 inch", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.ft);
    selectOption(user, TO_LABEL, LengthUnits.inch);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 yard: 36 inch", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.yard);
    selectOption(user, TO_LABEL, LengthUnits.inch);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 yard: 3 ft", async () => {
    ...
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.yard);
    selectOption(user, TO_LABEL, LengthUnits.ft);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 mile: 63360 inch", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.mile);
    selectOption(user, TO_LABEL, LengthUnits.inch);
    await typeInput(user, INPUT_LABEL, "1");
  ...
  test("1 mile: 1760 yard", async () => {
    ...
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.mile);
    selectOption(user, TO_LABEL, LengthUnits.yard);
    await typeInput(user, INPUT_LABEL, "1");
...
describe("Imperial to Metric", () => {
  ...
  test("1 inch: 2.540 cm", async () => {
    ...
    const user = userEvent.setup();
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.inch);
    selectOption(user, TO_LABEL, LengthUnits.cm);
    await typeInput(user, INPUT_LABEL, "1");
...
describe("Metric to Imperial", () => {
  test("1 km: 0.621 mile", async () => {
    ...
    clearInput(user, INPUT_LABEL);
    selectOption(user, FROM_LABEL, LengthUnits.km);
    selectOption(user, TO_LABEL, LengthUnits.mile);
    await typeInput(user, INPUT_LABEL, "1");
